...
`,ZF=ce.p`
    ...
    letter-spacing: 1px;
    line-height: 175%;
`;function JF(n){const e=SS().id,[t,r]=X.useState(null),[a,o]=X.useState({id:0,title:"",content:"",comments:[],image:t});return X.useEffect(()=>{ed.collection("post").doc(e).get().then(u=>{o(u.data())})},[]),J.jsxs("div",{children:[J.jsx(zv,{page:1}),J.jsx($F,{title:a.title,date:a.date}),J.jsxs(KF,{children:[J.jsxs(QF,{children:[J.jsx(WF,{children:J.jsx(YF,{src:a.image})}),J.jsx(XF,{children:J.jsx(ZF,{children:a.content})})]}),J.jsx(VF,{comments:a.comments,post:a,setPost:o})]}),J.jsx(Fv,{})]})}YP.createRoot(document.getElementById("root")).render(J.jsx(uO,{basename:"/",children:J.jsxs(zN,{children:[J.jsx(sp,{index:!0,element:J.jsx(hF,{})}),J.jsx(sp,{path:"write",element:J.jsx(SF,{})}),J.jsx(sp,{path:"post/:id",element:J.jsx(JF,{})})]})}));
