...
`,Ck=ce.div`
    ...
    width: 16px;
    height: 16px;
    background-image: url(/mini-blog/DateIcon.svg);
...
`,aR=ce.div`
    ...
    width: 36px;
    height: 36px;
    background-image: url(/mini-blog/LogoIcon.svg);
    transition: 0.15s all ease-in-out;
...
`,Mk=ce(aR)`
    width: 32px;
    height: 32px;
    background-image: url(/mini-blog/SearchIcon.svg);
`,hy=ce.span`
    font-size: 20px;
    font-weight: 500;
    transition: 0.15s all ease-in-out;
...
`,oR=ce.div`
    ...
    width: 24px;
    height: 24px;
    background-image: url(/mini-blog/Instagram.png);
`,Bk=ce(oR)`
    background-image: url(/mini-blog/Facebook.png);
`,zk=ce.div`
    display: flex;
    position: absolute;
    top: 0%;
...
`,Gk=ce.div`
    ...
    width: 140px;
    height: 120px;
    background-image: url(/mini-blog/MainImgLeft.png);
...
`,$k=ce.div`
    ...
    width: 489px;
    height: 277px;
    background-image: url(/mini-blog/MainImgRight.png);
    background-repeat: no-repeat;
    background-position: center;
`,Kk=ce.div`
    display: flex;
...
`,BF=ce.div`
    ...
    width: 140px;
    height: 120px;
    background-image: url(/mini-blog/MainImgLeftReverse.png);
    background-repeat: no-repeat;
    background-position: center;
`,zF=ce.h1`
    margin: 0;
